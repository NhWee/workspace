...
- `recommend_spectral_choppy_asset_bundle.py`: sweep/bundle metric 기반 다음 export 후보 추천
- `plan_spectral_choppy_production_export.py`: 추천 후보에서 고해상도 export plan 생성
- `validate_spectral_choppy_asset_bundle.py`: asset bundle 파일/metric/glTF/GLB animation 구조 검증
...
- `recommend_spectral_choppy_asset_bundle_guide.txt`: choppy wave asset bundle 추천 설명
- `plan_spectral_choppy_production_export_guide.txt`: choppy wave production export plan 설명
- `validate_spectral_choppy_asset_bundle_guide.txt`: choppy wave asset bundle 검증 설명
